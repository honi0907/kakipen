...
public static class HostMonitorHelper
{
    ...
    public static void ApplyWin32Borderless(IntPtr hwnd, bool popupStyle = false)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[HostMonitorHelper] ApplyWin32Borderless failed: {ex}");
        }
    }
    ...
    public static bool SetWindowBounds(IntPtr hwnd, MonitorBounds bounds)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[HostMonitorHelper] SetWindowBounds failed: {ex}");
            return false;
        }
    }
    ...
    private static void ApplyDwmBorderless(IntPtr hwnd)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[HostMonitorHelper] ApplyDwmBorderless failed: {ex}");
        }
    }
