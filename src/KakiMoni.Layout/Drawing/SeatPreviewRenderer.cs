...
public static class SeatPreviewRenderer
{
        ...
        Func<string, Color>? parseColor = null)
    {
        ...
        var colorParser = parseColor ?? (hex => ParseStrokeColor(hex, model, AppLayoutContext.JudgeColorMode));
    ...
    public static Color ParseStrokeColor(string hex, SeatDisplayModel? model, bool judgeColorMode = false)
    {
        var invert = judgeColorMode
